...
function RutaProtegidaPorRol({ permitido, rol, children }: { permitido: string[]; rol: string; children: ReactElement; }) {
...
export function AppRoutes() {
  ...
  if (!token) return <BrowserRouter><Routes><Route path="*" element={<Login />} /></Routes></BrowserRouter>;
    ...
    <BrowserRouter>
      <Routes>
        <Route element={<AppLayout />}>
          ...
          <Route path="/admin/instituciones" element={<RutaProtegidaPorRol permitido={['superadministrador']} rol={rol}><Instituciones /></RutaProtegidaPorRol>} />
          <Route path="/admin/usuarios" element={<RutaProtegidaPorRol permitido={rolesAdmin} rol={rol}><CrudAdmin titulo="Usuarios" endpoint="/usuarios" campos={[{name:'nombres',label:'Nombres'},{name:'apellidos',label:'Apellidos'},{name:'correo',label:'Correo'},{name:'documento',label:'Documento'},{name:'rolId',label:'Rol ID',type:'number'},{name:'institucionId',label:'Institución ID',type:'number'},{name:'tipoDocumento',label:'Tipo Doc'},{name:'genero',label:'Género'},{name:'fechaNacimiento',label:'Fecha Nacimiento'},{name:'contrasena',label:'Contraseña'}]} /></RutaProtegidaPorRol>} />
          <Route path="/admin/categorias" element={<RutaProtegidaPorRol permitido={rolesAdmin} rol={rol}><CrudAdmin titulo="Categorías" endpoint="/categorias" campos={[{name:'nombre',label:'Nombre'},{name:'descripcion',label:'Descripción'},{name:'color',label:'Color'},{name:'institucionId',label:'Institución ID',type:'number'}]} /></RutaProtegidaPorRol>} />
